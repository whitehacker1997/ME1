...
VALUES
	(1,1,N'short_name','Учитель'),(1,1,N'full_name','Врач'),
	(1,2,N'short_name','Ўқитувчи'),(1,2,N'full_name','Шифокор'),
	(1,3,N'short_name','O`qituvchi'),(1,3,N'full_name','Shifokor'),
	(1,4,N'short_name','Teacher'),(1,4,N'full_name','Doctor');
